// server.js – Single file, all-in-one, no external HTML needed
...
app.get('/a9f3k217', (req, res) => {
    // The entire HTML is embedded here to avoid file serving issues
