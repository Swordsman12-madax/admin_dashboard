// server.js – WORKING BACKGROUND IMAGE
...
app.get('/a9f3k217', (req, res) => {
    // ... (keep your existing dashboard HTML here)
    // For brevity, I'm not including the full dashboard HTML here.
    // You should copy your existing dashboard code from your current server.js.
    res.send(`
        <html>
